...
public class Menu 
{
	...
	private void init()
	{
		...
		bt[1].setBounds(300,700,120,50);	          //四个功能按钮在面板的位置
		bt[2].setBounds(600,700,120,50);	
		bt[3].setBounds(900,700,120,50);
		bt[4].setBounds(1200,700,120,50);
		...
		title.setBounds(600, 20,550, 60);				//标题位置
		...
		bt[4].addActionListener(new ActionListener()	//添加数据按钮
		{
			public void actionPerformed(ActionEvent e) 
			{
				new AddData();             //添加类类,加载添加数据界面
			}
		});
		
		frame.add(panel);                      //向框中加入面板
		frame.setSize(1600,900);               //框的大小
